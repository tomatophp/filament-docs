...
use TomatoPHP\FilamentDocs\Filament\Resources\DocumentResource\RelationManagers;
        ...
        $schema = [
            ...
            Forms\Components\Section::make(trans('filament-docs::messages.documents.form.document'))
                ...
                ->schema(function ($record){
                    if($record){
                        return [
                            TiptapEditor::make('body')->label(trans('filament-docs::messages.documents.form.body'))
                                ->required(),
                        ];
                    }
                    else {
